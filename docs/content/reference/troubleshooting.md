...
Most of these come down to network reality or how uniref serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

uniref rate-limits like any public site. uniref already paces
...
Where a surface is gated, uniref reads a cookie or token you supply
...
`uniref`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what uniref actually did
