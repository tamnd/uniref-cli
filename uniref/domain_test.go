...
// HTTP behaviour is covered in uniref_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "uniref://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("uniref", "about")
	if err != nil || got.String() != "uniref://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want uniref://page/about", got.String(), err)
	}
}
